...
local function removeESP(player)
    for _, gui in pairs(espFolder:GetChildren()) do
        if gui.Name == "ESP" and gui.Adornee and gui.Adornee.Parent == player.Character then
            gui:Destroy()
        end
    end
end
...
-- Clean up ESP if adornee disappears
...
-- Example: Change ESP color after 5 seconds to green
-- You can replace this with a GUI color picker
task.delay(5, function()
    updateESPColor(Color3.fromRGB(0, 255, 0))
end)
